sap.ui.define([
    ...
    return PluginViewController.extend("company.custom.plugins.expirydate.expirydate.controller.MainView", {
        onInit: function () {
        ...
        onMaterialValueHelpRequest: function () {
            ...
            if (!this.oMaterialVHDia) {
                ...
                this.oMaterialVHDia = sap.ui.xmlfragment(
                    "company.custom.plugins.expirydate.expirydate.view.fragments.MaterialValueHelpRequest",
                    this
                );
        ...
        onBatchValueHelpRequest: function () {
            ...
            if (!this.oBatchVHDia) {
                ...
                this.oBatchVHDia = sap.ui.xmlfragment(
                    "company.custom.plugins.expirydate.expirydate.view.fragments.BatchValueHelpRequest",
                    this
                );
